...
from model.optimizers_modify_sep_10 import Santa_modify
...
def train_model(tr, va, te, n_x=88, n_h=200, patience=10, max_epochs=100-98, 
    ...
    f_grad_shared, f_update = Santa_modify(beta, batchsize, tparams, cost, [x], lr_, eidx_, ntrain_, maxepoch_)
